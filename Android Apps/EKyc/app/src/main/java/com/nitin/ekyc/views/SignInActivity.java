...
public class SignInActivity extends AppCompatActivity {
    ...
    private void makeUserIdValidationRequest(final JSONObject payload) {
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            JSONObject payload = new JSONObject();
                            CommonUtils.setUserBhamashahId(CurrentUserHolder.getInstance().getmUser().getBhamashahId());
        ...
        validateUserIdRequest.setRetryPolicy(KycApp.getDefaultRetryPolice());
        KycApp.getInstance().getRequestQueue().add(validateUserIdRequest);
    ...
    private void makeGetAllDocumentsRequest(final JSONObject payload) {
        ...
        getAllDocumentsRequest.setTag(RequestTags.SIGN_IN_REQUESTS_TAG);
