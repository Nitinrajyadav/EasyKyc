...
import com.nitin.ekyc.repository.remote.OkHttpStack;
...
public class KycApp extends Application {
    ...
    private static final String TAG = com.nitin.ekyc.KycApp.class.getSimpleName();
    private static com.nitin.ekyc.KycApp mInstance;
    private RequestQueue mRequestQueue;


    public static synchronized com.nitin.ekyc.KycApp getInstance() {
        return mInstance;
    }
