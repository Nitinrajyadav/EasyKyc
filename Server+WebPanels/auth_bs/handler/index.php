...
if(isset($_POST['logIn']))
{
	...
	if(isset($_SESSION['id']))
	{	
		$result = mysqli_query($con,"SELECT userid,password FROM v_auth where userid='$username' and password='$password'");
		...
		if($row["userid"]==$username && $row["password"]==$password)
		{
		    ...
		    mysqli_query($con,"UPDATE v_auth SET token='".$_SESSION['token']."' WHERE userid='$username'");
