...
<head>
        ...
        <title>AUTHORITY ADMIN AREA | EASY KYC | BARSPAN</title>
    ...
    <body>
        <div class="login" data-lbg="blue">
            ...
            <div class="l-block toggled" id="l-login">
                <div class="lb-header palette-Light-Blue bg">
...
<form method="post" role="form" id="logIn" action="handler/">
                <div class="lb-body">
                    ...
                    <button type="submit" name="logIn" class="btn palette-Light-Blue bg">Sign in</button>
