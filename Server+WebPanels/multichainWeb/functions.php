<?php
	...
	function set_multichain_config(){

		$rootChain = array();
		$rootChain['name'] = "Default";
		$rootChain['rpchost'] = "127.0.0.1";
		$rootChain['rpcport'] = "7314";
		$rootChain['rpcuser'] = "multichainrpc";
		$rootChain['rpcpassword'] = "DDaCwc3GfjgxgPgoNZizpZuVa8ENJrgMV6hHN1z9vAyS";

		set_multichain_chain($rootChain);
	}
